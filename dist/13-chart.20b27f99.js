...
(function () {
  ...
  function ready(datapoints) {
    ...
    var xPositionScale = d3.scaleLinear().domain([0, 15]).range([0, 550]);
    var names = datapoints.map(function (d) {
      return d.name;
    });
    var yScale = d3.scaleBand().domain(names).range([600, 0]);
    ...
    svg.append("g").attr("class", "axis x-axis").attr("transform", "translate(0," + 600 + ")").call(xAxis).lower();
    svg.append("text").attr("x", 200).attr("y", 650).text("hamburgers consumed");
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","13-chart.js"], null)
//# sourceMappingURL=/13-chart.20b27f99.map