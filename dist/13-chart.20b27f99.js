...
(function () {
  ...
  function ready(datapoints) {
    ...
    var xPositionScale = d3.scaleLinear().domain([0, 15]).range([0, width]);
    var names = datapoints.map(function (d) {
      return d.name;
    });
    var yScale = d3.scaleBand().domain(["Stevie", "Nicholas", "Bubbletree", "Particle", "Jumpup", "Parlay", "Hio"]).range([height, 0]);
